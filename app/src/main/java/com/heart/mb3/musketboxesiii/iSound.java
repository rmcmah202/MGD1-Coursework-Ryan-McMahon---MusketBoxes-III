package com.heart.mb3.musketboxesiii;
...
public class iSound {
    ...
    iSound(final Context context)
    {
        ...
        try {
            ...
            AssetFileDescriptor afd = ctx.getAssets().openFd("Ouchie.mp3");
            ...
            afd = ctx.getAssets().openFd("GunNoise.mp3");
        ...
        musicIDs[0] = "BackgroundMusic.mp3";
